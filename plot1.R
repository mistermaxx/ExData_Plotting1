...
# | Week 1 Programming Assignment: Plot 1
# |*****************************************************************************
...
plot1 <- function()
{
  ...
  hist(energy.plot.data$Global_active_power, main = paste("Global Active Power"), col="red", xlab="Global Active Power (in kilowatts)")
